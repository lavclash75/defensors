...
export default function Qui() {
  ...
  <h1 class="qui">Qui Som / Què Fem</h1>
  
  <div class="text">
    <p class="font">Els nostres socis són recreadors que en la seva majoria estant dins el món de la recreació des de l’any 2009. La nostra Associació està formada per gent d’arreu de Catalunya i fins i tot de Suïssa.    </p>
  ...
  <div class="home">
  <img class="quisom" src="assets/images/qui.png" alt=''/>
  </div>
